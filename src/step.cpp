...
extern "C" {
void step0_nothreads(float* r, const float* d, int n) {
    for (int i = 0; i < n; ++i) {
        for (int j = 0; j < n; ++j) {
...
void step0(float* r, const float* d, int n) {
...
void step1(float* r, const float* d, int n) {
...
void step5(float* r, const float* d_, int n) {
...
void step6(float* r, const float* d_, int n) {
  // vectors per input column
  int na = (n + 8 - 1) / 8;
